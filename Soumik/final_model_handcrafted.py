...
def process_abundance_h(class_file: str):
    ...
    dict = {"filename": class_file, "wt": {"Wt_Mg": mg, "Wt_Al": al, "Wt_Si": si, "Wt_Ca": ca, "Wt_Fe": fe,"Wt_Ti":ti}}

    return dict


if __name__ == "__main__":
    dict = process_abundance_h("/home/pg/Documents/Astral-Ray-Scratchpad/Pratham/comined_fits_test/-1.120_88.800_weighted_average.fits")
