...
def get_df_mg(class_file: str, return_model: bool = False) -> Tuple[float, float, float, Optional[List[Dict[str, float]]]]:
    ...
    model.gaussian.Sigma = 0.035  # type: ignore
    model.gaussian.norm = 1  # type: ignore
    model.gaussian.LineE.frozen = True  # type: ignore
    model.gaussian.Sigma.frozen = True  # type: ignore
...
def process_abundance_h_v3(class_file: str, return_model: bool = False) -> Dict[str, Dict[str, float]]:
    set_xset_settings()
...
if __name__ == "__main__":
    dict = process_abundance_h_v3("/home/sm/Public/Inter-IIT/Astral-Ray-Scratchpad/Soumik/-0.00_2.41.fits")
